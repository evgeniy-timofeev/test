...
<section  id="join">
	<h2>SQL JOIN</h2>
	<p>6. Доработайте код предыдущего теста, чтобы отображалось объединение двух таблиц (набор столбцов в результате – объединение полей таблиц), связанных внешними ключами.</p>
